...
(function() { this.JST || (this.JST = {}); this.JST["cmn/templates/envelope"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div class="envelope">\n    <div class="flap"></div>\n    <div class="paper">\n        <h6>');
      
        __out.push(__sanitize(this.symbol));
      
        __out.push(__sanitize(this.number));
      
        __out.push('</h6>\n    </div>\n    <i class="icon icon-');
      
        __out.push(__sanitize(this.iconSymbol));
...
(function() { this.JST || (this.JST = {}); this.JST["cmn/templates/player_score"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
